...
public class Corba2XMLHelper {
	...
	public void printContainedTPParams(TerminationPoint_T terminationPoint, String sncID, String ctpInput)
			throws ProcessingFailureException, SAXException {

		handler.printStructure(getContainedTPParams(terminationPoint, sncID, ctpInput));
	}

	public Corba2XMLContainer getContainedTPParams(TerminationPoint_T terminationPoint, String sncID, String ctpInput)
			throws ProcessingFailureException {
		...
		Corba2XMLContainer container = new Corba2XMLContainer(Corba2XMLStructure.CONTAINED_POTENTIAL_TPS);
	...
	public Corba2XMLContainer getRouteAndTopologicalLinksParams(TopologicalLink_T topologicalLink, String sncId)
			throws ProcessingFailureException {
	...
	public void printFDFrs(FlowDomainFragment_T[] fdfrList) throws SAXException, ProcessingFailureException {
		if (fdfrList == null) {
			return;
		}
	...
	public Corba2XMLContainer getFDFrsParams(FlowDomainFragment_T value) throws ProcessingFailureException {
		Corba2XMLContainer container = new Corba2XMLContainer(Corba2XMLStructure.FLOWDOMAIN_FRAGMENTS);
		...
		container.setFieldValue(CorbaConstants.NETWORK_ACCESS_DOMAIN_STR, String.valueOf(value.networkAccessDomain));
		...
		container.setFieldValue(CorbaConstants.FLEXIBLE_STR, String.valueOf(value.flexible));
		container.setFieldValue(CorbaConstants.FDFR_TYPE_STR, value.fdfrType);
		container.setFieldValue(CorbaConstants.FDFR_STATE_STR, String.valueOf(value.fdfrState.value()));

		container.setFieldValue(CorbaConstants.A_END_STR, String.valueOf(handler.convertTPDatasToString(value.aEnd)));
		container.setFieldValue(CorbaConstants.Z_END_STR, String.valueOf(handler.convertTPDatasToString(value.zEnd)));

		container.setFieldValue(CorbaConstants.TRANSMISSION_PARAMS_STR,
				handler.convertLayeredParameterToString(value.transmissionParams));
		container.setFieldValue(CorbaConstants.ADDITIONAL_INFO_STR,
	...
	public void printTopologicalLinksOfFDFr(FlowDomainFragment_T fdfr, TopologicalLink_T[] list)
	...
	public Corba2XMLContainer getTopologicalLinksOfFDFrParams(FlowDomainFragment_T fdfr,
			TopologicalLink_T topologicalLink) throws ProcessingFailureException {
		Corba2XMLContainer container = new Corba2XMLContainer(Corba2XMLStructure.EVC_TRANSPORT_LINKS);

		container.setFieldValue("FDFR_NAME", handler.getValueByName(fdfr.name, "FlowDomainFragment"));
