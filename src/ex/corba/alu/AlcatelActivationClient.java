...
public class AlcatelActivationClient extends AlcatelConnection {
	...
	public static void main(String[] args) {
		...
		try {
			...
			main.createE1WWithNEtpInc();
			// main.createE1WithSNCP();
			// main.createE1WithSNCPWithConstraints();
	...
	public void createE1WWithNEtpInc() throws ProcessingFailureException {
		...
		neTpInclusions[1][3] = new NameAndStringValue_T("PTP",
				"NISA_CC2/r01s1b01p004c1");
	...
	public void createE1WithSNCPWithConstraints()
	...
	public void deactivateAndDeleteSNC() throws ProcessingFailureException {
		...
		for (String sncID : sncIDsList) {
			...
			cmd.deactivateAndDeleteSNC(sncName, tolerableImpact,
