...
public class HuaweiActivationClient extends HuaweiConnection {
	...
	public void createVC4_16cWithCCInc() throws ProcessingFailureException {
		...
		aEndCCList[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=28/domain=sdh/port=1");
		...
		zEndCCList[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=13/domain=sdh/port=1");
		...
		aEndCCList1[0][1] = new NameAndStringValue_T("ManagedElement",
				"3145729");
		aEndCCList1[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=11/domain=sdh/port=1");
	...
	public void createVC4_4cWithCCInc() throws ProcessingFailureException {
		...
		// VC4_16c circuit
		aEnd[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=7/domain=sdh/port=4");
		...
		// VC4_16c circuit
		zEnd[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=7/domain=sdh/port=2");
	...
	public void createVC3withCCIncOnMSP() throws ProcessingFailureException {
		...
		aEndCCList2[0][1] = new NameAndStringValue_T("ManagedElement",
				"3145729");
		aEndCCList2[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=14/domain=sdh/port=1");
		aEndCCList2[0][3] = new NameAndStringValue_T("CTP",
				"/sts3c_au4-j=2/tu3_vc3-k=2");
		...
		aEndCCList3[0][1] = new NameAndStringValue_T("ManagedElement",
				"3145732");
		aEndCCList3[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=24/domain=sdh/port=1");
		aEndCCList3[0][3] = new NameAndStringValue_T("CTP",
				"/sts3c_au4-j=2/tu3_vc3-k=2");
	...
	public void createSncpE1withCCIncOnMSP() throws ProcessingFailureException {
		...
		zEndCCList0[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=13/domain=sdh/port=1");
		zEndCCList0[0][3] = new NameAndStringValue_T("CTP",
				"/sts3c_au4-j=2/vt2_tu12-k=1-l=1-m=1");
		...
		zEndCCList2[0][1] = new NameAndStringValue_T("ManagedElement",
				"3145729");
		zEndCCList2[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=8/domain=sdh/port=4");
		zEndCCList2[0][3] = new NameAndStringValue_T("CTP",
				"/sts3c_au4-j=1/vt2_tu12-k=1-l=1-m=1");
		...
		zEndCCList3[0][1] = new NameAndStringValue_T("ManagedElement",
				"3145729");
		zEndCCList3[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=14/domain=sdh/port=1");
		zEndCCList3[0][3] = new NameAndStringValue_T("CTP",
				"/sts3c_au4-j=2/vt2_tu12-k=1-l=1-m=1");
		...
		aEndCCList4[0][1] = new NameAndStringValue_T("ManagedElement",
				"3145732");
		aEndCCList4[0][2] = new NameAndStringValue_T("PTP",
				"/rack=1/shelf=1/slot=18/domain=sdh/port=4");
		aEndCCList4[0][3] = new NameAndStringValue_T("CTP",
				"/sts3c_au4-j=1/vt2_tu12-k=1-l=1-m=1");
		...
		ccInclusions[4].additionalInfo[0] = new NameAndStringValue_T(
				"ProtectionRole", "Protection");
		...
		ccInclusions[5].additionalInfo[0] = new NameAndStringValue_T(
				"ProtectionRole", "Protection");
	...
	public void configureEthernetPort() throws ProcessingFailureException {
		...
		loopback[11] = new NameAndStringValue_T(
				"AutoNegotiationFlowControlMode", "AutoNeg_Non-Symmetric");
