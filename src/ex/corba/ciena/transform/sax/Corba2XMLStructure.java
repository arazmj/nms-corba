...
/**
 * Describe structure of XML that is created as result of serialization of CORBA
 * entities
 */
public enum Corba2XMLStructure {
	...
	NETWORK_ELEMENTS("NETWORK_ELEMENTS", new String[] {
			...
			CorbaConstants.NE_NAME_STR, CorbaConstants.OWNER_STR,
			CorbaConstants.LOCATION_STR, CorbaConstants.VERSION_STR,
			CorbaConstants.PRODUCT_NAME_STR,
			CorbaConstants.COMMUNICATION_STATE_STR,
			CorbaConstants.EMS_INSYNC_STATE_STR,
			CorbaConstants.SUPPORTED_RATES_STR, CorbaConstants.GATEWAYS_STR }),

	/**
	 * CORBA entity: Equipment_T
	 */
	CARDS("CARDS", new String[] { CorbaConstants.NE_ID_STR,
			CorbaConstants.HOLDER_STR, CorbaConstants.SLOT_N_STR,
			CorbaConstants.USER_LABEL_STR, CorbaConstants.NATIVE_EMS_NAME_STR,
			CorbaConstants.OWNER_STR, CorbaConstants.ALARM_REPORT_INDIC_STR,
	 ...
	 */
	HOLDERS("HOLDERS", new String[] { CorbaConstants.NE_ID_STR,
			CorbaConstants.HOLDER_STR, CorbaConstants.USER_LABEL_STR,
			...
			CorbaConstants.ACCEPT_EQUIPMENT_STR, CorbaConstants.STATE_STR,
			CorbaConstants.ADDITIONAL_INFO_STR }),

	/**
	 * CORBA entity: TerminationPoint_T
	 */
	PTPS("PTPS", new String[] { CorbaConstants.NE_ID_STR,
			CorbaConstants.USER_LABEL_STR, CorbaConstants.NATIVE_EMS_NAME_STR,
			CorbaConstants.OWNER_STR, CorbaConstants.IN_TRAFFIC_DES_NAME_STR,
			CorbaConstants.EG_TRAFFIC_DES_NAME_STR, CorbaConstants.PTP_STR,
			CorbaConstants.FTP_STR, CorbaConstants.CTP_STR,
			CorbaConstants.TYPE_STR, CorbaConstants.CONNECTION_STATE_STR,
	...
	GTPS("GTPS", new String[] { CorbaConstants.NE_ID_STR,
			CorbaConstants.NATIVE_EMS_NAME_STR, CorbaConstants.GTP_STR,
			CorbaConstants.TP_STR, CorbaConstants.CONNECTION_STATE_STR,
			CorbaConstants.ADDITIONAL_INFO_STR,
	 ...
	 */
	TOPOL_LINKS("TOPO_LINKS", new String[] { CorbaConstants.USER_LABEL_STR,
			CorbaConstants.TL_ID_STR, CorbaConstants.NATIVE_EMS_NAME_STR,
			CorbaConstants.OWNER_STR, CorbaConstants.DIRECTION_STR,
			CorbaConstants.RATE_STR, CorbaConstants.A_END_NE_STR,
	 ...
	 */
	FLOWDOMAIN_FRAGMENTS("FLOWDOMAIN_FRAGMENT", new String[] {
			CorbaConstants.NATIVE_EMS_NAME_STR, CorbaConstants.USER_LABEL_STR,
			CorbaConstants.OWNER_STR, CorbaConstants.NAME_STR,
			CorbaConstants.NETWORK_ACCESS_DOMAIN_STR,
			CorbaConstants.ADMINISTRATIVE_STATE_STR,
			CorbaConstants.DIRECTION_STR, CorbaConstants.FLEXIBLE_STR,
			CorbaConstants.FDFR_TYPE_STR, CorbaConstants.FDFR_STATE_STR,
	 ...
	 */
	SNCS("SNCS", new String[] { CorbaConstants.SNC_ID_STR,
			CorbaConstants.USER_LABEL_STR, CorbaConstants.NATIVE_EMS_NAME_STR,
			CorbaConstants.OWNER_STR, CorbaConstants.SNC_STATE_STR,
			CorbaConstants.DIRECTION_STR, CorbaConstants.RATE_STR,
			CorbaConstants.STATIC_PROTECTION_LEVEL_STR,
			CorbaConstants.SNC_TYPE_STR, CorbaConstants.A1_TPNAME_NE_STR,
			CorbaConstants.A1_TPNAME_PTP_STR, CorbaConstants.A1_TPNAME_CTP_STR,
			CorbaConstants.A1_TPMAPPING_MODE_STR,
			CorbaConstants.A2_TPNAME_NE_STR, CorbaConstants.A2_TPNAME_PTP_STR,
			CorbaConstants.A2_TPNAME_CTP_STR,
			CorbaConstants.A2_TPMAPPING_MODE_STR,
			CorbaConstants.Z1_TPNAME_NE_STR, CorbaConstants.Z1_TPNAME_PTP_STR,
			CorbaConstants.Z1_TPNAME_CTP_STR,
			CorbaConstants.Z1_TPMAPPING_MODE_STR,
			CorbaConstants.Z2_TPNAME_NE_STR, CorbaConstants.Z2_TPNAME_PTP_STR,
			CorbaConstants.Z2_TPNAME_CTP_STR,
			CorbaConstants.Z2_TPMAPPING_MODE_STR,
			CorbaConstants.REROUTE_ALLOWED_STR,
			CorbaConstants.NETWORK_REROUTED_STR, CorbaConstants.FREQ_A_STR,
			CorbaConstants.FREQ_Z_STR, CorbaConstants.ADDITIONAL_INFO_STR });
